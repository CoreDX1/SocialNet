...
public interface IMessageService
{
    ...
    Task<PagedResult<ConversationDto>> GetConversationsAsync(Guid userId, int page, int pageSize, CancellationToken ct = default);
    Task<PagedResult<MessageDto>> GetConversationAsync(Guid userId, Guid otherUserId, int page, int pageSize, CancellationToken ct = default);
